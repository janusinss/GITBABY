...
-- ==========================================
-- Triggers removed in favor of dynamic calculation
-- ==========================================
...
-- Skills Data
INSERT INTO skills (profile_id, name, type, icon)
VALUES (1, 'HTML', 'programming', 'img/html_icon.png'),
    (1, 'CSS', 'programming', 'img/css_icon.png'),
    (1, 'C++', 'programming', 'img/c++_icon.png'),
    (
        1,
        'JavaScript',
        'programming',
    ...
    (1, 'PHP', 'programming', 'img/php_icon.png'),
    (1, 'MySQL', 'programming', 'img/mysql_icon.png'),
    (
        1,
        'Python',
        'programming',
...
INSERT INTO hobbies (profile_id, name, description, icon, category)
VALUES (
        1,
        'Figma',
...
VALUES (
        1,
        'Cake Shop Website - cakes & co.',
        'A beautiful e-commerce website for a cake shop',
        '#',
        'img/cakeshop.png',
        'UI/UX Design,Wireframe,Web Design',
        1
    ),
    (
        1,
...
VALUES (
        ...
        2020,
        'Present',
        'Currently pursuing a degree in BS in Computer Science with a focus in Web Development and Software engineering',
        1
    ),
    (
        1,
        ...
        2025,
        '2025',
        'Learned fundamental Web Development concepts, including HTML structure, CSS styling, and JavaScript interactivity. Gained practical experience in creating dynamic and interactive user interfaces.',
        2
    );
-- ==========================================
